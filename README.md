...
<p>On each map, <span style="color: #00b33c">green indicates more favorable values,</span> and <span style="color: #ff0000">red indicates less favorable values</span>. For example, we can see that these counties have moderate to severe WHP risk.</p> 
